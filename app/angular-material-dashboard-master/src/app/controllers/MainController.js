(function(){
  ...
  function MainController(navService, $mdSidenav, $mdBottomSheet, $log, $q, $state, $mdToast, $mdMedia) {
    ...
    vm.showSecondNavbar = true;
    vm.getSecondNavbarIcon = getSecondNavbarIcon;
    vm.toggleSecondNavbar = toggleSecondNavbar;
    vm.$mdMedia = $mdMedia;
    ...
    function toggleSecondNavbar() {
      vm.showSecondNavbar = !vm.showSecondNavbar;
    }
    
    function getSecondNavbarIcon () {
      if (vm.showSecondNavbar) {
